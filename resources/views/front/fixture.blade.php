        ...
        <div class="col-lg-12">
            <table class="table-striped table-responsive table-hover">
                ...
                <tbody>
                    <tr>
                        <td>
                            <img src="{{ asset_front('img/clubs-logos/colombia.png') }}" alt="icon">
                            <strong>Colombia</strong><br>
                            <small class="meta-text">GROUP H.</small>
                        </td>
                        <td class="text-center">Vs</td>
                        <td>
                            <img src="{{ asset_front('img/clubs-logos/japan.png') }}" alt="icon1">
                    ...
                    <tr>
                        <td>
                            <img src="{{ asset_front('img/clubs-logos/pol.png') }}" alt="icon1">
                    ...
                    <tr>
                        <td>
                            <img src="{{ asset_front('img/clubs-logos/sen.png') }}" alt="icon1">
